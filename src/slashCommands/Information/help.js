...
module.exports = {
  ...
  const embed = new EmbedBuilder()
    ...
    .setDescription(`Hey**<@${message.author.id}>**, I'm <@${client.user.id}>!\n\n **I am Developed by Team Kronix To Play Best Music Ever!**\n\n__**My Features Are**__\n\n<:partner:1072147908364877834> **Home**\n<a:music_disk_kastro:1064432083558211645> **Music**\n<:Enable_kastro:1064433434396733460> **Info**\n<a:commands_kastro:1064407280554098770> Config\n\n __**Developers**__\n **akshat**\n **A R J U N**\n **мя.ƒιcкℓιηg**  `)
